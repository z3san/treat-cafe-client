...
const reviews = [
  {
    ...
    rating: 4.5,
    review:
      '"This burger is amazing! The meat is so juicy and flavorful. The bun is perfectly toasted and the toppings are fresh and tasty. Highly recommend!" -Richard Hammond ',
    imageUrl:
  ...
  },
  {
    ...
    rating: 4.0,
    review:
      '"This pizza is so good! The crust is crispy on the outside and chewy on the inside, and the sauce and toppings are perfectly balanced. Would definitely order again".-Jeremy Clarkson',
    imageUrl:
  ...
  },
  {
    ...
    rating: 4.8,
    review:
      '"This salad is surprisingly filling! The greens are fresh and the toppings are delicious. The dressing is a bit too tangy for my taste, but overall it was a great meal." -James May ',
    imageUrl:
...
<div className="card-body">
  ...
  <p className='italic text-gray-500'>{review.review}</p>
